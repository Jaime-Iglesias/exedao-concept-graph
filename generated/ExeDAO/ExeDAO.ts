...
export class ExeDAO extends SmartContract {
  ...
  try_nextNonce(daoist: Address): CallResult<BigInt> {
    let result = super.tryCall("nextNonce", [
      EthereumValue.fromAddress(daoist)
    ]);
    if (result.reverted) {
  ...
  try_getDaoist(
    daoistAddress: Address
  ): CallResult<ExeDAO__getDaoistResultDaoistStruct> {
    let result = super.tryCall("getDaoist", [
      EthereumValue.fromAddress(daoistAddress)
    ]);
    if (result.reverted) {
      return new CallResult();
    ...
    return CallResult.fromValue(
      value[0].toTuple() as ExeDAO__getDaoistResultDaoistStruct
    );
  }
  ...
  try_getProposalMetaHash(proposalHash: Bytes): CallResult<Bytes> {
    let result = super.tryCall("getProposalMetaHash", [
      EthereumValue.fromFixedBytes(proposalHash)
    ]);
    if (result.reverted) {
      return new CallResult();
  ...
  try_getExtensionFor(
    funcSig: Bytes
  ): CallResult<ExeDAO__getExtensionForResultExtensionStruct> {
    let result = super.tryCall("getExtensionFor", [
      EthereumValue.fromFixedBytes(funcSig)
    ]);
    if (result.reverted) {
      return new CallResult();
    ...
    let value = result.value;
    return CallResult.fromValue(
      value[0].toTuple() as ExeDAO__getExtensionForResultExtensionStruct
    );
  }
  ...
  try_getProposal(
    proposalHash: Bytes
  ): CallResult<ExeDAO__getProposalResultRetStruct> {
    let result = super.tryCall("getProposal", [
      EthereumValue.fromFixedBytes(proposalHash)
    ]);
    if (result.reverted) {
      return new CallResult();
    ...
    let value = result.value;
    return CallResult.fromValue(
      value[0].toTuple() as ExeDAO__getProposalResultRetStruct
    );
  }
  ...
  try_getToken(
  ...
  ): CallResult<ExeDAO__getTokenResultTokenValueStruct> {
    ...
    let value = result.value;
    return CallResult.fromValue(
      value[0].toTuple() as ExeDAO__getTokenResultTokenValueStruct
    );
  }
  ...
  try_getApplication(
    applicant: Address
  ): CallResult<ExeDAO__getApplicationResultApplicationStruct> {
    let result = super.tryCall("getApplication", [
      EthereumValue.fromAddress(applicant)
    ]);
    if (result.reverted) {
      return new CallResult();
    ...
    let value = result.value;
    return CallResult.fromValue(
      value[0].toTuple() as ExeDAO__getApplicationResultApplicationStruct
    );
  }
  ...
  try_getApprovalRequirements(funcSigs: Array<Bytes>): CallResult<Array<i32>> {
    let result = super.tryCall("getApprovalRequirements", [
      EthereumValue.fromFixedBytesArray(funcSigs)
    ]);
    if (result.reverted) {
      return new CallResult();
  ...
  try_getMinimumTribute(): CallResult<BigInt> {
    let result = super.tryCall("getMinimumTribute", []);
    if (result.reverted) {
      return new CallResult();
    }
    let value = result.value;
  ...
  try_submitWithMetaHash(
    proposalHash: Bytes,
    metaHash: Bytes
  ): CallResult<BigInt> {
    let result = super.tryCall("submitWithMetaHash", [
      EthereumValue.fromFixedBytes(proposalHash),
      EthereumValue.fromFixedBytes(metaHash)
    ]);
    if (result.reverted) {
  ...
  try_getTotalShares(): CallResult<BigInt> {
    let result = super.tryCall("getTotalShares", []);
    if (result.reverted) {
      return new CallResult();
    }
    let value = result.value;
  ...
  try_submitOrVote(
    proposalHash: Bytes
  ): CallResult<ExeDAO__submitOrVoteResult> {
    let result = super.tryCall("submitOrVote", [
      EthereumValue.fromFixedBytes(proposalHash)
    ]);
    if (result.reverted) {
      return new CallResult();
    ...
    let value = result.value;
    return CallResult.fromValue(
      new ExeDAO__submitOrVoteResult(value[0].toBigInt(), value[1].toBigInt())
    );
  }
  ...
  try_getExtension(
    index: BigInt
  ): CallResult<ExeDAO__getExtensionResultValue0Struct> {
    let result = super.tryCall("getExtension", [
      EthereumValue.fromUnsignedBigInt(index)
    ]);
    if (result.reverted) {
      return new CallResult();
    ...
    let value = result.value;
    return CallResult.fromValue(
      value[0].toTuple() as ExeDAO__getExtensionResultValue0Struct
    );
  }
  ...
  try_getApprovalRequirement(funcSig: Bytes): CallResult<i32> {
    let result = super.tryCall("getApprovalRequirement", [
      EthereumValue.fromFixedBytes(funcSig)
    ]);
    if (result.reverted) {
      return new CallResult();
